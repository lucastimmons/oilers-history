$(window).load(function(){
			...
			uninter.div5 = R.rect(42.3664,1035.099,17.314,10.663).attr(attr);
			uninter.div6 = R.rect(42.3664,1045.904,17.314,10.664).attr(attr2);
			...
			uninter.div126 = R.rect(514.266,1056.71,17.226,10.664).attr(attr);
			uninter.div127 = R.rect(514.266,1045.904,17.226,10.664).attr(attr2);
			...
			inter.divposi1 = R.rect(42.3664,981.068,17.314,86.663).attr(attrblank);
			inter.divposi2 = R.rect(63.8164,981.068,17.314,86.663).attr(attrblank);
			inter.divposi3 = R.rect(85.2664,981.068,17.314,86.663).attr(attrblank);
			inter.divposi4 = R.rect(106.716,981.068,17.314,86.663).attr(attrblank);
			inter.divposi5 = R.rect(128.166,981.068,17.314,86.663).attr(attrblank);
			inter.divposi6 = R.rect(149.616,981.068,17.314,86.663).attr(attrblank);
			inter.divposi7 = R.rect(171.066,981.068,17.314,86.663).attr(attrblank);
			inter.divposi8 = R.rect(192.516,981.068,17.314,86.663).attr(attrblank);
			inter.divposi9 = R.rect(213.966,981.068,17.314,86.663).attr(attrblank);
			inter.divposi10 = R.rect(235.416,981.068,17.314,86.663).attr(attrblank);
			inter.divposi11 = R.rect(256.866,981.068,17.314,86.663).attr(attrblank);
			inter.divposi12 = R.rect(278.316,981.068,17.314,86.663).attr(attrblank);
			inter.divposi13 = R.rect(299.766,981.068,17.314,86.663).attr(attrblank);
			inter.divposi14 = R.rect(321.216,981.068,17.314,86.663).attr(attrblank);
			inter.divposi15 = R.rect(342.666,981.068,17.314,86.663).attr(attrblank);
			inter.divposi16 = R.rect(364.116,981.068,17.314,86.663).attr(attrblank);
			inter.divposi17 = R.rect(385.566,981.068,17.314,86.663).attr(attrblank);
			inter.divposi18 = R.rect(407.016,981.068,17.314,86.663).attr(attrblank);
			inter.divposi19 = R.rect(428.466,981.068,17.314,86.663).attr(attrblank);
			inter.divposi20 = R.rect(449.916,981.068,17.314,86.663).attr(attrblank);
			inter.divposi21 = R.rect(471.366,981.068,17.314,86.663).attr(attrblank);
			inter.divposi22 = R.rect(492.816,981.068,17.314,86.663).attr(attrblank);
			inter.divposi23 = R.rect(514.266,981.068,17.314,86.663).attr(attrblank);
			inter.divposi24 = R.rect(535.716,981.068,17.314,86.663).attr(attrblank);
			inter.divposi25 = R.rect(557.166,981.068,17.314,86.663).attr(attrblank);
			inter.divposi26 = R.rect(578.616,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi27 = R.rect(600.066,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi28 = R.rect(621.516,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi29 = R.rect(642.966,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi30 = R.rect(664.416,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi31 = R.rect(685.866,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi32 = R.rect(707.316,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi33 = R.rect(750.216,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi34 = R.rect(771.666,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi35 = R.rect(793.116,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi36 = R.rect(814.566,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi37 = R.rect(836.016,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi38 = R.rect(857.466,981.068,17.314,86.663).attr(attrblank);
			inter2.divposi39 = R.rect(878.916,981.068,17.314,86.663).attr(attrblank);

			inter.battlei1 = R.rect(192.516,1280.081,16.962,129).attr(attrblank);
			inter.battlei2 = R.rect(213.966,1280.081,16.962,129).attr(attrblank);
			inter.battlei3 = R.rect(235.416,1280.081,16.962,129).attr(attrblank);
			inter.battlei4 = R.rect(256.866,1280.081,16.962,129).attr(attrblank);
			inter.battlei5 = R.rect(278.316,1280.081,16.962,129).attr(attrblank);
			inter.battlei6 = R.rect(299.766,1280.081,16.962,129).attr(attrblank);
			inter.battlei7 = R.rect(321.216,1280.081,16.962,129).attr(attrblank);
			inter.battlei8 = R.rect(342.666,1280.081,16.962,129).attr(attrblank);
			inter.battlei9 = R.rect(364.116,1280.081,16.962,129).attr(attrblank);
			inter.battlei10 = R.rect(385.566,1280.081,16.962,129).attr(attrblank);
			inter.battlei11 = R.rect(407.016,1280.081,16.962,129).attr(attrblank);
			...
			inter2.battlei21 = R.rect(621.516,1280.081,16.962,129).attr(attrblank);
			inter2.battlei22 = R.rect(642.966,1280.081,16.962,129).attr(attrblank);
			inter2.battlei23 = R.rect(664.416,1280.081,16.962,129).attr(attrblank);
			inter2.battlei24 = R.rect(685.866,1280.081,16.962,129).attr(attrblank);
			inter2.battlei25 = R.rect(707.316,1280.081,16.962,129).attr(attrblank);
			inter2.battlei26 = R.rect(750.216,1280.081,16.962,129).attr(attrblank);
			inter2.battlei27 = R.rect(771.666,1280.081,16.962,129).attr(attrblank);
			inter2.battlei28 = R.rect(793.116,1280.081,16.962,129).attr(attrblank);
			inter2.battlei29 = R.rect(814.566,1280.081,16.962,129).attr(attrblank);
			inter2.battlei30 = R.rect(836.016,1280.081,16.962,129).attr(attrblank);
			inter2.battlei31 = R.rect(857.466,1280.081,16.962,129).attr(attrblank);
			inter2.battlei32 = R.rect(878.916,1280.081,16.962,129).attr(attrblank);

			inter.playoffi1 = R.rect(42.3664,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi2 = R.rect(63.8164,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi3 = R.rect(85.2664,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi4 = R.rect(106.716,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi5 = R.rect(128.166,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi6 = R.rect(149.616,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi7 = R.rect(171.066,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi8 = R.rect(192.516,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi9 = R.rect(213.966,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi10 = R.rect(235.416,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi11 = R.rect(256.866,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi12 = R.rect(278.316,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi13 = R.rect(299.766,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi14 = R.rect(321.216,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi15 = R.rect(342.666,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi16 = R.rect(364.116,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi17 = R.rect(385.566,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi18 = R.rect(407.016,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi19 = R.rect(428.466,1131.812,16.775,84.248).attr(attrblank);
			inter.playoffi20 = R.rect(449.916,1131.812,16.775,84.248).attr(attrblank);
			...
			inter2.playoffi28 = R.rect(621.516,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi29 = R.rect(642.966,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi30 = R.rect(664.416,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi31 = R.rect(685.866,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi32 = R.rect(707.316,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi33 = R.rect(750.216,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi34 = R.rect(771.666,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi35 = R.rect(793.116,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi36 = R.rect(814.566,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi37 = R.rect(836.016,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi38 = R.rect(857.466,1131.812,16.775,84.248).attr(attrblank);
			inter2.playoffi39 = R.rect(878.916,1131.812,16.775,84.248).attr(attrblank);

						//attendance
			inter.attend1 = R.rect(42.3664,901.729,16.87,36.812).attr(attr);
			inter.attend2 = R.rect(63.8164,896.147,16.87,42.394).attr(attr);
			inter.attend3 = R.rect(85.2664,862.677,16.87,75.864).attr(attr);
			inter.attend4 = R.rect(106.716,835.838,16.87,102.559).attr(attr);
			inter.attend5 = R.rect(128.166,858.316,16.87,80.225).attr(attr);
			inter.attend6 = R.rect(149.616,840.686,17.06,97.855).attr(attr);
			inter.attend7 = R.rect(171.066,830.638,16.87,107.903).attr(attr);
			inter.attend8 = R.rect(192.516,771.275,16.87,167.153).attr(attr);
			inter.attend9 = R.rect(213.966,771.275,16.87,167.153).attr(attr);
			inter.attend10 = R.rect(235.416,790.826,16.87,147.57).attr(attr);
			inter.attend11 = R.rect(256.866,771.275,16.87,167.153).attr(attr);
			inter.attend12 = R.rect(278.316,770.993,16.87,167.399).attr(attr);
			inter.attend13 = R.rect(299.766,770.993,16.87,167.545).attr(attr);
			inter.attend14 = R.rect(321.216,773.997,16.87,164.541).attr(attr);
			inter.attend15 = R.rect(342.666,770.441,16.87,167.955).attr(attr);
			inter.attend16 = R.rect(364.116,771.276,16.87,167.12).attr(attr);
			inter.attend17 = R.rect(385.566,771.276,16.87,167.12).attr(attr);
			inter.attend18 = R.rect(407.016,775.826,16.87,162.57).attr(attr);
			inter.attend19 = R.rect(428.466,776.964,16.87,161.578).attr(attr);
			inter.attend20 = R.rect(449.916,783.504,16.87,155.038).attr(attr);
			inter.attend21 = R.rect(471.366,796.229,16.87,142.313).attr(attr);
			inter.attend22 = R.rect(492.816,810.155,16.87,128.388).attr(attr);
			inter.attend23 = R.rect(514.266,812.999,16.87,125.393).attr(attr);
			inter.attend24 = R.rect(535.716,820.393,16.87,118).attr(attr);
			inter.attend25 = R.rect(557.166,784.927,16.87,153.465).attr(attr);
			inter.attend26 = R.rect(578.616,782.936,16.87,155.456).attr(attr);
			inter.attend27 = R.rect(600.066,782.936,16.87,155.456).attr(attr);
			inter2.attend28 = R.rect(621.516,787.409,16.87,150.982).attr(attr);
			inter2.attend29 = R.rect(642.966,789.403,16.87,148.988).attr(attr);
			inter2.attend30 = R.rect(664.416,779.45,16.87,158.94).attr(attr);
			inter2.attend31 = R.rect(685.866,778.953,16.87,159.438).attr(attr);
			inter2.attend32 = R.rect(707.316,768.074,16.87,170.316).attr(attr);
			inter2.attend33 = R.rect(750.216,777.531,16.87,160.851).attr(attr);
			inter2.attend34 = R.rect(771.666,777.531,16.87,160.851).attr(attr);
			inter2.attend35 = R.rect(793.116,777.531,16.87,160.851).attr(attr);
			inter2.attend36 = R.rect(814.566,777.531,16.87,160.851).attr(attr);
			inter2.attend37 = R.rect(836.016,777.531,16.87,160.851).attr(attr);
			inter2.attend38 = R.rect(857.466,777.531,16.87,160.851).attr(attr);
			inter2.attend39 = R.rect(878.916,777.531,16.87,160.851).attr(attr);
			...
			inter.huntero = R.rect(42.3664,106.354,59.713,21.816).attr(attr);
			inter.skalbaniao = R.rect(106.716,106.354,38.404,21.816).attr(attr);
			inter.pocklingtono = R.rect(149.616,106.354,446.015,21.816).attr(attr);
			inter2.eigo = R.rect(600.066,106.354,209.371,21.816).attr(attr);
			inter2.katzo = R.rect(814.566,106.354,102.571,21.816).attr(attr);

			//gms
			inter.hunterg = R.rect(42.3664,170.318,81.033,21.816).attr(attr);
			inter.guidoling = R.rect(128.166,170.318,17.042,21.816).attr(attr);
			inter.conacherg = R.rect(149.616,170.318,17.042,21.816).attr(attr);
			inter.gordong = R.rect(171.066,170.318,37.789,21.816).attr(attr);
			inter.satherg = R.rect(213.966,170.318,424.983,21.816).attr(attr);
			inter2.loweg = R.rect(642.966,170.318,167.664,21.816).attr(attr);
			inter2.tambellinig = R.rect(814.566,170.318,103.664,21.816).attr(attr);

			//coaches
			inter.kinasewichc = R.rect(42.3664,255.771,17.042,21.816).attr(attr);
			inter.shawc = R.rect(63.8164,255.771,28.578,21.816).attr(attr);
			inter.hunterc = R.rect(94.742,255.771,7.521,21.816).attr(attr);
			inter.drakec = R.rect(106.716,255.771,17.042,21.816).attr(attr);
			inter.gouidolinc = R.rect(128.166,255.771,6.209,21.816).attr(attr);
			inter.satherc = R.rect(137.804,255.771,92,21.816).attr(attr);
			...
			inter2.lowc = R.rect(525.781,255.771,91.445,21.816).attr(attr);
			inter2.lowec = R.rect(621.516,255.771,17.486,21.816).attr(attr);
			inter2.mactavishc = R.rect(642.966,255.771,187.434,21.816).attr(attr);
			inter2.quinnc = R.rect(836.016,255.771,17.487,21.816).attr(attr);
			inter2.renneyc = R.rect(857.466,255.771,38.252,21.816).attr(attr);
			inter2.kruegerc = R.rect(900.366,255.771,17.487,21.816).attr(attr);

			//arenas
			inter.gardensa = R.rect(42.3664,426.552,38.404,21.816).attr(attr);
			inter.northlandsa = R.rect(85.2664,426.552,446.415,21.816).attr(attr);
			inter2.coliseum = R.rect(535.716,426.552,60.14,21.816).attr(attr);
			inter2.skyreacha = R.rect(600.066,426.552,61.229,21.816).attr(attr);
			inter2.rexalla = R.rect(664.416,426.552,253.041,21.816).attr(attr);

			//captains
			inter.hamiltonca = R.rect(42.3664,341.508,102.34,21.816).attr(attr);
			inter.satherca = R.rect(149.616,341.508,17.494,21.816).attr(attr);
			inter.shmyrca = R.rect(171.066,341.508,37.789,21.816).attr(attr);
			inter.chipperfieldca = R.rect(213.966,341.508,16.587,21.816).attr(attr);
			inter.macdonaldca = R.rect(235.416,341.508,16.587,21.816).attr(attr);
			inter.fogolinac = R.rect(256.866,341.508,37.363,21.816).attr(attr);
			inter.gretzkyca = R.rect(299.766,341.508,103.061,21.816).attr(attr);
			inter.messierca = R.rect(407.016,341.508,58.711,21.816).attr(attr);
			inter.loweca = R.rect(471.366,341.508,16.587,21.816).attr(attr);
			inter.mactavishca = R.rect(492.816,341.508,38.273,21.816).attr(attr);
			inter2.corsonca = R.rect(535.716,341.508,16.587,21.816).attr(attr);
			inter2.buchbergerca = R.rect(557.166,341.508,81.141,21.816).attr(attr);
			inter2.weightca = R.rect(642.966,341.508,38.532,21.816).attr(attr);
			inter2.smithca = R.rect(685.866,341.508,123.905,21.816).attr(attr);
			inter2.moreauca = R.rect(814.566,341.508,59.647,21.816).attr(attr);
			inter2.horcoffca = R.rect(878.916,341.508,38.314,21.816).attr(attr);



			//allstars
			inter.allstar1 = R.path("M51.473,714.003 45.735,712.901 42.915,707.784 \r\n\t\t\t\t40.094,712.901 34.356,714.003 38.35,718.268 37.625,724.065 42.915,721.584 48.204,724.065 47.479,718.268 \t\t\tz").attr(attr);
			inter.allstar2 = R.path("M72.797,714.003 67.06,712.901 64.239,707.784 \r\n\t\t\t\t61.418,712.901 55.681,714.003 59.675,718.268 58.95,724.065 64.239,721.584 69.528,724.065 68.804,718.268 \t\t\tz").attr(attr);
			inter.allstar3 = R.path("M94.406,714.003 88.669,712.901 85.848,707.784 \r\n\t\t\t\t83.027,712.901 77.29,714.003 81.283,718.268 80.559,724.065 85.848,721.584 91.137,724.065 90.412,718.268 \t\t\tz").attr(attr);
			inter.allstar4 = R.path("M115.73,714.003 109.993,712.901 107.172,707.784 \r\n\t\t\t\t104.351,712.901 98.614,714.003 102.608,718.268 101.883,724.065 107.172,721.584 112.461,724.065 111.737,718.268 \t\t\tz").attr(attr);
			inter.allstar5 = R.path("M137.055,714.003 131.317,712.901 128.497,707.784 \r\n\t\t\t\t125.676,712.901 119.938,714.003 123.932,718.268 123.207,724.065 128.497,721.584 133.786,724.065 133.061,718.268 \t\t\tz").attr(attr);
			inter.allstar6 = R.path("M158.379,714.003 152.642,712.901 149.821,707.784 \r\n\t\t\t\t147,712.901 141.263,714.003 145.257,718.268 144.532,724.065 149.821,721.584 155.11,724.065 154.386,718.268 \t\t\tz").attr(attr);
			inter.allstar7 = R.path("M179.988,714.003 174.251,712.901 171.43,707.784 \r\n\t\t\t\t168.609,712.901 162.872,714.003 166.865,718.268 166.141,724.065 171.43,721.584 176.719,724.065 175.994,718.268 \t\t\tz").attr(attr);
			inter.allstar8 = R.path("M201.028,714.003 195.291,712.901 192.47,707.784 \r\n\t\t\t\t189.649,712.901 183.912,714.003 187.905,718.268 187.181,724.065 192.47,721.584 197.759,724.065 197.034,718.268 \t\t\tz").attr(attr);
			inter.allstar9 = R.path("M222.068,714.003 216.331,712.901 213.51,707.784 \r\n\t\t\t\t210.689,712.901 204.952,714.003 208.946,718.268 208.221,724.065 213.51,721.584 218.799,724.065 218.075,718.268 \t\t\tz").attr(attr);
			inter.allstar10 = R.path("M243.108,714.003 237.371,712.901 234.55,707.784 \r\n\t\t\t\t231.729,712.901 225.992,714.003 229.986,718.268 229.261,724.065 234.55,721.584 239.839,724.065 239.115,718.268 \t\t\tz").attr(attr);
			inter.allstar11 = R.path("M264.433,714.003 258.695,712.901 255.875,707.784 \r\n\t\t\t\t253.054,712.901 247.316,714.003 251.31,718.268 250.585,724.065 255.875,721.584 261.164,724.065 260.439,718.268 \t\t\tz").attr(attr);
			inter.allstar12 = R.path("M285.757,714.003 280.02,712.901 277.199,707.784 \r\n\t\t\t\t274.378,712.901 268.641,714.003 272.635,718.268 271.91,724.065 277.199,721.584 282.488,724.065 281.764,718.268 \t\t\tz").attr(attr);
			inter.allstar13 = R.path("M307.082,714.003 301.344,712.901 298.523,707.784 \r\n\t\t\t\t295.703,712.901 289.965,714.003 293.959,718.268 293.234,724.065 298.523,721.584 303.813,724.065 303.088,718.268 \t\t\tz").attr(attr);
			inter.allstar14 = R.path("M328.69,714.003 322.953,712.901 320.132,707.784 \r\n\t\t\t\t317.312,712.901 311.574,714.003 315.567,718.268 314.843,724.065 320.132,721.584 325.422,724.065 324.696,718.268 \t\t\tz").attr(attr);
			inter.allstar15 = R.path("M371.055,714.003 365.317,712.901 362.497,707.784 \r\n\t\t\t\t359.676,712.901 353.938,714.003 357.933,718.268 357.207,724.065 362.497,721.584 367.786,724.065 367.062,718.268 \t\t\tz").attr(attr);
			inter.allstar16 = R.path("M392.664,714.003 386.927,712.901 384.105,707.784 \r\n\t\t\t\t381.284,712.901 375.547,714.003 379.541,718.268 378.816,724.065 384.105,721.584 389.395,724.065 388.67,718.268 \t\t\tz").attr(attr);
			inter.allstar17 = R.path("M413.988,714.003 408.251,712.901 405.43,707.784 \r\n\t\t\t\t402.609,712.901 396.872,714.003 400.865,718.268 400.141,724.065 405.43,721.584 410.719,724.065 409.994,718.268 \t\t\tz").attr(attr);
			inter.allstar18 = R.path("M435.028,714.003 429.291,712.901 426.47,707.784 \r\n\t\t\t\t423.649,712.901 417.912,714.003 421.905,718.268 421.181,724.065 426.47,721.584 431.76,724.065 431.034,718.268 \t\t\tz").attr(attr);
			inter.allstar19 = R.path("M456.353,714.003 450.615,712.901 447.794,707.784 \r\n\t\t\t\t444.974,712.901 439.236,714.003 443.229,718.268 442.505,724.065 447.794,721.584 453.084,724.065 452.358,718.268 \t\t\tz").attr(attr);
			inter.allstar20 = R.path("M477.677,714.003 471.939,712.901 469.119,707.784 \r\n\t\t\t\t466.298,712.901 460.561,714.003 464.555,718.268 463.829,724.065 469.119,721.584 474.408,724.065 473.684,718.268 \t\t\tz").attr(attr);
			inter.allstar21 = R.path("M499.286,714.003 493.549,712.901 490.728,707.784 \r\n\t\t\t\t487.906,712.901 482.169,714.003 486.163,718.268 485.438,724.065 490.728,721.584 496.017,724.065 495.292,718.268 \t\t\tz").attr(attr);
			inter.allstar22 = R.path("M541.65,714.003 535.913,712.901 533.092,707.784 \r\n\t\t\t\t530.271,712.901 524.534,714.003 528.527,718.268 527.803,724.065 533.092,721.584 538.382,724.065 537.656,718.268 \t\t\tz").attr(attr);
			inter.allstar23 = R.path("M562.975,714.003 557.237,712.901 554.416,707.784 \r\n\t\t\t\t551.596,712.901 545.858,714.003 549.852,718.268 549.127,724.065 554.416,721.584 559.706,724.065 558.98,718.268 \t\t\tz").attr(attr);
			inter2.allstar24 = R.path("M584.299,714.003 578.562,712.901 575.741,707.784 \r\n\t\t\t\t572.92,712.901 567.183,714.003 571.177,718.268 570.451,724.065 575.741,721.584 581.03,724.065 580.306,718.268 \t\t\tz").attr(attr);
			inter2.allstar25 = R.path("M605.624,714.003 599.887,712.901 597.065,707.784 \r\n\t\t\t\t594.244,712.901 588.507,714.003 592.501,718.268 591.776,724.065 597.065,721.584 602.354,724.065 601.63,718.268 \t\t\tz").attr(attr);
			inter2.allstar26 = R.path("M627.232,714.003 621.495,712.901 618.674,707.784 \r\n\t\t\t\t615.854,712.901 610.116,714.003 614.109,718.268 613.385,724.065 618.674,721.584 623.964,724.065 623.238,718.268 \t\t\tz").attr(attr);
			inter2.allstar27 = R.path("M648.557,714.003 642.819,712.901 639.998,707.784 \r\n\t\t\t\t637.178,712.901 631.44,714.003 635.434,718.268 634.709,724.065 639.998,721.584 645.288,724.065 644.562,718.268 \t\t\tz").attr(attr);
			inter2.allstar28 = R.path("M669.597,714.003 663.859,712.901 661.039,707.784 \r\n\t\t\t\t658.218,712.901 652.48,714.003 656.475,718.268 655.749,724.065 661.039,721.584 666.328,724.065 665.604,718.268 \t\t\tz").attr(attr);
			inter2.allstar29 = R.path("M690.921,714.003 685.184,712.901 682.363,707.784 \r\n\t\t\t\t679.542,712.901 673.805,714.003 677.799,718.268 677.073,724.065 682.363,721.584 687.652,724.065 686.928,718.268 \t\t\tz").attr(attr);
			inter2.allstar30 = R.path("M713.099,714.003 707.361,712.901 704.54,707.784 \r\n\t\t\t\t701.72,712.901 695.982,714.003 699.976,718.268 699.251,724.065 704.54,721.584 709.83,724.065 709.104,718.268 \t\t\tz").attr(attr);
			inter2.allstar31 = R.path("M775.935,714.003 770.197,712.901 767.376,707.784 \r\n\t\t\t\t764.556,712.901 758.818,714.003 762.812,718.268 762.087,724.065 767.376,721.584 772.666,724.065 771.94,718.268 \t\t\tz").attr(attr);
			inter2.allstar32 = R.path("M797.543,714.003 791.806,712.901 788.985,707.784 \r\n\t\t\t\t786.164,712.901 780.427,714.003 784.421,718.268 783.695,724.065 788.985,721.584 794.274,724.065 793.55,718.268 \t\t\tz").attr(attr);
			inter2.allstar33 = R.path("M818.868,714.003 813.131,712.901 810.31,707.784 \r\n\t\t\t\t807.488,712.901 801.751,714.003 805.745,718.268 805.021,724.065 810.31,721.584 815.599,724.065 814.874,718.268 \t\t\tz").attr(attr);
			inter2.allstar34 = R.path("M861.517,714.003 855.779,712.901 852.958,707.784 \r\n\t\t\t\t850.138,712.901 844.4,714.003 848.394,718.268 847.669,724.065 852.958,721.584 858.248,724.065 857.522,718.268 \t\t\tz").attr(attr);
			inter2.allstar35 = R.path("M883.125,714.003 877.388,712.901 874.567,707.784 \r\n\t\t\t\t871.746,712.901 866.009,714.003 870.003,718.268 869.277,724.065 874.567,721.584 879.856,724.065 879.132,718.268 \t\t\tz").attr(attr);

			inter.allstar1.transform("t8,0");
			inter.allstar2.transform("t8,0");
			inter.allstar3.transform("t8,0");
			inter.allstar4.transform("t9,0");
			inter.allstar5.transform("t8,0");
			inter.allstar6.transform("t9,0");
			inter.allstar7.transform("t8,0");
			inter.allstar8.transform("t9,0");
			inter.allstar9.transform("t9,0");
			inter.allstar10.transform("t10,0");
			inter.allstar11.transform("t10,0");
			inter.allstar12.transform("t10,0");
			inter.allstar13.transform("t10,0");
			inter.allstar14.transform("t10,0");
			inter.allstar15.transform("t10,0");
			inter.allstar16.transform("t10,0");
			inter.allstar17.transform("t10,0");
			inter.allstar18.transform("t10,0");
			inter.allstar19.transform("t11,0");
			inter.allstar20.transform("t11,0");
			inter.allstar21.transform("t11,0");
			inter.allstar22.transform("t12,0");
			inter.allstar23.transform("t12,0");
			inter2.allstar24.transform("t12,0");
			inter2.allstar25.transform("t12,0");
			inter2.allstar26.transform("t12,0");
			inter2.allstar27.transform("t12,0");
			inter2.allstar28.transform("t12,0");
			inter2.allstar29.transform("t12,0");
			inter2.allstar30.transform("t12,0");
			inter2.allstar31.transform("t13,0");
			inter2.allstar32.transform("t13,0");
			inter2.allstar33.transform("t13,0");
			inter2.allstar34.transform("t13,0");
			inter2.allstar35.transform("t13,0");


			//winning percentage
			inter.winper1 = R.rect(42.3664,558.106,16.659,102.968).attr(attr);
			inter.winper2 = R.rect(63.8164,558.106,16.659,102.968).attr(attr);
			inter.winper3 = R.rect(85.2664,563.39,16.659,97.685).attr(attr);
			inter.winper4 = R.rect(106.716,590.7,16.659,70.374).attr(attr);
			inter.winper5 = R.rect(128.166,571.83,16.659,89.244).attr(attr);
			inter.winper6 = R.rect(149.616,560.32,16.659,100.754).attr(attr);
			inter.winper7 = R.rect(171.066,534.985,16.659,126.089).attr(attr);
			inter.winper8 = R.rect(192.516,587.252,16.659,73.822).attr(attr);
			inter.winper9 = R.rect(213.966,584.422,16.659,76.652).attr(attr);
			inter.winper10 = R.rect(235.416,533.85,16.659,127.225).attr(attr);
			inter.winper11 = R.rect(256.866,536.868,16.659,124.206).attr(attr);
			inter.winper12 = R.rect(278.316,510.264,16.659,150.811).attr(attr);
			inter.winper13 = R.rect(299.766,531.585,16.659,129.489).attr(attr);
			inter.winper14 = R.rect(321.216,512.523,16.659,148.551).attr(attr);
			inter.winper15 = R.rect(342.666,528.805,16.659,132.27).attr(attr);
			inter.winper16 = R.rect(364.116,544.891,16.659,116.184).attr(attr);
			inter.winper17 = R.rect(385.566,560.318,16.659,100.756).attr(attr);
			inter.winper18 = R.rect(407.016,560.318,16.659,100.756).attr(attr);
			inter.winper19 = R.rect(428.466,563.384,16.659,97.69).attr(attr);
			inter.winper20 = R.rect(449.916,565.6,16.659,95.475).attr(attr);
			inter.winper21 = R.rect(471.366,595.697,16.659,65.396).attr(attr);
			inter.winper22 = R.rect(492.816,598.217,16.659,62.857).attr(attr);
			inter.winper23 = R.rect(514.266,585.669,16.659,75.424).attr(attr);
			inter.winper24 = R.rect(535.716,583.983,16.659,77.109).attr(attr);
			inter.winper25 = R.rect(557.166,568.185,16.659,92.907).attr(attr);
			inter.winper26 = R.rect(578.616,570.774,16.659,90.3).attr(attr);
			inter.winper27 = R.rect(600.066,575.849,16.659,85.226).attr(attr);
			inter2.winper28 = R.rect(621.516,578.798,16.659,82.276).attr(attr);
			inter2.winper29 = R.rect(642.966,560.323,16.659,100.751).attr(attr);
			inter2.winper30 = R.rect(664.416,563.179,16.659,97.896).attr(attr);
			inter2.winper31 = R.rect(685.866,568.182,16.659,92.893).attr(attr);
			inter2.winper32 = R.rect(707.316,568.182,16.659,92.893).attr(attr);
			inter2.winper33 = R.rect(750.216,555.313,16.659,105.761).attr(attr);
			inter2.winper34 = R.rect(771.666,578.792,16.659,82.282).attr(attr);
			inter2.winper35 = R.rect(793.116,555.313,16.659,105.761).attr(attr);
			inter2.winper36 = R.rect(814.566,563.179,16.659,97.896).attr(attr);
			inter2.winper37 = R.rect(836.016,590.7,16.659,70.374).attr(attr);
			inter2.winper38 = R.rect(857.466,596.539,16.659,64.535).attr(attr);
			inter2.winper39 = R.rect(878.916,578.792,16.659,82.282).attr(attr);
			...
			backgg.text33 = R.text(215,371,"RC").attr(textmiddlewhite);
			backgg.text34 = R.text(237,371,"BM").attr(textmiddlewhite);
			backgg.text35 = R.text(258,371,"LF").attr(textmiddlewhite);
			backgg.text98 = R.text(301,371,"Wayne Gretzky").attr(textmiddlewhite);
			backgg.text36 = R.text(408,371,"MM").attr(textmiddlewhite);
			backgg.text37 = R.text(473,371,"KL").attr(textmiddlewhite);
			backgg.text38 = R.text(495,371,"CM").attr(textmiddlewhite);
			backgg.text39 = R.text(537,371,"SC").attr(textmiddlewhite);
			backgg.text40 = R.text(559,371,"KB").attr(textmiddlewhite);
			backgg.text41 = R.text(644,371,"DW").attr(textmiddlewhite);
			backgg.text92 = R.text(688,371,"Jason Smith").attr(textmiddlewhite);
			backgg.text42 = R.text(817,371,"EM").attr(textmiddlewhite);
			backgg.text43 = R.text(881,371,"SH").attr(textmiddlewhite);
			...
			backgg.text96 = R.text(667,455,"Rexal Place").attr(textmiddlewhite);

			backgg.textcredits1 = R.text(580,800,"Designed by: Lucas Timmons, edmontonjournal.com. Inspired by: Craig Robinson, Flip Flop Flyball, flipflopflyin.com/flipflopflyball/. Built using RaphaelJS ").attr(textmiddlewhite);
            ...
            for (var state in inter) {
             ...
             $(document).mousemove(function(e){
                  if (over){
                    $(tip).css("left", e.pageX-500).css("top", e.pageY-850);
                    $(tip).html(tipText);
                  }
              });
			...
			var current2 = null;
            for (var state2 in inter2) {
                inter2[state2].color = "#ffffff";
                (function (st, state2) {
                    st[0].style.cursor = "pointer";

                    var state2ID = '#'+state2;
                    var state2Content = $(state2ID).html();

                    $(st[0]).mouseover(function(){
                      current2 && inter2[current2].animate({fill: "#DE6A28", stroke: "#666"}, 500) && (document.getElementById(current2).style.display = "");
                        st.animate({fill: st.color, stroke: "#ccc"}, 500);
                        R.safari();


                        tipText = state2Content;
            ...
            for (var state3 in inter3) {
             ...
             $(document).mousemove(function(e){
                  if (over3){
                    $(tip).css("left", e.pageX+50).css("top", e.pageY-800);
                    $(tip).html(tipText);
                  }
              });
