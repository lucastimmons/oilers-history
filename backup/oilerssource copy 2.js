$(window).load(function(){
			...
			inter3.divposi1 = R.rect(42.3664,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi2 = R.rect(63.8164,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi3 = R.rect(85.2664,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi4 = R.rect(106.716,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi5 = R.rect(128.166,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi6 = R.rect(149.616,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi7 = R.rect(171.066,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi8 = R.rect(192.516,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi9 = R.rect(213.966,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi10 = R.rect(235.416,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi11 = R.rect(256.866,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi12 = R.rect(278.316,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi13 = R.rect(299.766,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi14 = R.rect(321.216,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi15 = R.rect(342.666,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi16 = R.rect(364.116,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi17 = R.rect(385.566,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi18 = R.rect(407.016,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi19 = R.rect(428.466,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi20 = R.rect(449.916,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi21 = R.rect(471.366,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi22 = R.rect(492.816,981.068,17.314,86.663).attr(attrblank);
			...
			inter.divposi27 = R.rect(600.066,981.068,17.314,86.663).attr(attrblank);
			inter.divposi28 = R.rect(621.516,981.068,17.314,86.663).attr(attrblank);
			inter.divposi29 = R.rect(642.966,981.068,17.314,86.663).attr(attrblank);
			inter.divposi30 = R.rect(664.416,981.068,17.314,86.663).attr(attrblank);
			inter.divposi31 = R.rect(685.866,981.068,17.314,86.663).attr(attrblank);
			inter.divposi32 = R.rect(707.316,981.068,17.314,86.663).attr(attrblank);
			inter.divposi33 = R.rect(750.216,981.068,17.314,86.663).attr(attrblank);
			inter.divposi34 = R.rect(771.666,981.068,17.314,86.663).attr(attrblank);
			inter.divposi35 = R.rect(793.116,981.068,17.314,86.663).attr(attrblank);
			inter.divposi36 = R.rect(814.566,981.068,17.314,86.663).attr(attrblank);
			inter.divposi37 = R.rect(836.016,981.068,17.314,86.663).attr(attrblank);
			inter.divposi38 = R.rect(857.466,981.068,17.314,86.663).attr(attrblank);
			inter.divposi39 = R.rect(878.916,981.068,17.314,86.663).attr(attrblank);
			...
			inter.attend28 = R.rect(621.516,787.409,16.87,150.982).attr(attr);
			inter.attend29 = R.rect(642.966,789.403,16.87,148.988).attr(attr);
			inter.attend30 = R.rect(664.416,779.45,16.87,158.94).attr(attr);
			inter.attend31 = R.rect(685.866,778.953,16.87,159.438).attr(attr);
			inter.attend32 = R.rect(707.316,768.074,16.87,170.316).attr(attr);
			inter.attend33 = R.rect(750.216,777.531,16.87,160.851).attr(attr);
			inter.attend34 = R.rect(771.666,777.531,16.87,160.851).attr(attr);
			inter.attend35 = R.rect(793.116,777.531,16.87,160.851).attr(attr);
			inter.attend36 = R.rect(814.566,777.531,16.87,160.851).attr(attr);
			inter.attend37 = R.rect(836.016,777.531,16.87,160.851).attr(attr);
			inter.attend38 = R.rect(857.466,777.531,16.87,160.851).attr(attr);
			inter.attend39 = R.rect(878.916,777.531,16.87,160.851).attr(attr);
			...
			inter3.satherg = R.rect(213.966,170.318,424.983,21.816).attr(attr);
			...
			inter3.satherc3 = R.rect(247,255.771,143,21.816).attr(attr);
			inter3.watsonc = R.rect(235.416,255.771,7,21.816).attr(attr);
			...
			inter3.shmyrca = R.rect(171.066,341.508,37.789,21.816).attr(attr);
			inter3.chipperfieldca = R.rect(213.966,341.508,16.587,21.816).attr(attr);
			inter3.macdonaldca = R.rect(235.416,341.508,16.587,21.816).attr(attr);
			inter3.fogolinac = R.rect(256.866,341.508,37.363,21.816).attr(attr);
			inter3.gretzkyca = R.rect(299.766,341.508,103.061,21.816).attr(attr);
			...
			inter.allstar24.transform("t12,0");
			inter.allstar25.transform("t12,0");
			inter.allstar26.transform("t12,0");
			inter.allstar27.transform("t12,0");
			inter.allstar28.transform("t12,0");
			inter.allstar29.transform("t12,0");
			inter.allstar30.transform("t12,0");
			inter.allstar31.transform("t13,0");
			inter.allstar32.transform("t13,0");
			inter.allstar33.transform("t13,0");
			inter.allstar34.transform("t13,0");
			inter.allstar35.transform("t13,0");


			//winning percentage
			inter3.winper1 = R.rect(42.3664,558.106,16.659,102.968).attr(attr);
			inter3.winper2 = R.rect(63.8164,558.106,16.659,102.968).attr(attr);
			inter3.winper3 = R.rect(85.2664,563.39,16.659,97.685).attr(attr);
			inter3.winper4 = R.rect(106.716,590.7,16.659,70.374).attr(attr);
			inter3.winper5 = R.rect(128.166,571.83,16.659,89.244).attr(attr);
			inter3.winper6 = R.rect(149.616,560.32,16.659,100.754).attr(attr);
			inter3.winper7 = R.rect(171.066,534.985,16.659,126.089).attr(attr);
			inter3.winper8 = R.rect(192.516,587.252,16.659,73.822).attr(attr);
			inter3.winper9 = R.rect(213.966,584.422,16.659,76.652).attr(attr);
			inter3.winper10 = R.rect(235.416,533.85,16.659,127.225).attr(attr);
			inter3.winper11 = R.rect(256.866,536.868,16.659,124.206).attr(attr);
			inter3.winper12 = R.rect(278.316,510.264,16.659,150.811).attr(attr);
			inter3.winper13 = R.rect(299.766,531.585,16.659,129.489).attr(attr);
			inter3.winper14 = R.rect(321.216,512.523,16.659,148.551).attr(attr);
			inter3.winper15 = R.rect(342.666,528.805,16.659,132.27).attr(attr);
			inter3.winper16 = R.rect(364.116,544.891,16.659,116.184).attr(attr);
			inter3.winper17 = R.rect(385.566,560.318,16.659,100.756).attr(attr);
			inter3.winper18 = R.rect(407.016,560.318,16.659,100.756).attr(attr);
			inter3.winper19 = R.rect(428.466,563.384,16.659,97.69).attr(attr);
			inter3.winper20 = R.rect(449.916,565.6,16.659,95.475).attr(attr);
			inter2.winper21 = R.rect(471.366,595.697,16.659,65.396).attr(attr);
			inter2.winper22 = R.rect(492.816,598.217,16.659,62.857).attr(attr);
			inter2.winper23 = R.rect(514.266,585.669,16.659,75.424).attr(attr);
			inter2.winper24 = R.rect(535.716,583.983,16.659,77.109).attr(attr);
			inter2.winper25 = R.rect(557.166,568.185,16.659,92.907).attr(attr);
			inter2.winper26 = R.rect(578.616,570.774,16.659,90.3).attr(attr);
			inter2.winper27 = R.rect(600.066,575.849,16.659,85.226).attr(attr);
            ...
            for (var state2 in inter2) {
                ...
                (function (st, state2) {
                    ...
                    $(st[0]).mouseover(function(){
                      current2 && inter2[current2].animate({fill: "#DE6A28", stroke: "#666"}, 500) && (document.getElementById(current2).style.display = "");
                        ...
                        tipText2 = state2Content;

                        // tip.fadeIn();
                        $(tip2).stop(true, true).fadeIn();
             ...
             $(document).mousemove(function(e){
                  if (over2){
                    $(tip2).css("left", e.pageX-500).css("top", e.pageY-850);
                    $(tip2).html(tipText2);
                  }
              });
            ...
            for (var state3 in inter3) {
             ...
             $(document).mousemove(function(e){
                  if (over3){
                    $(tip).css("left", e.pageX-200).css("top", e.pageY-850);
                    $(tip).html(tipText);
                  }
              });
//
            ...
            for (var state4 in inter4) {
             ...
             $(document).mousemove(function(e){
                  if (over4){
                    $(tip).css("left", e.pageX-200).css("top", e.pageY-850).css("width", "200px");
                    $(tip).html(tipText);
                  }
              });
