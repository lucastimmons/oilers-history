$(window).load(function(){
			...
			inter3.battlei12 = R.rect(428.466,1280.081,16.962,129).attr(attrblank);
			inter3.battlei13 = R.rect(449.916,1280.081,16.962,129).attr(attrblank);
			inter3.battlei14 = R.rect(471.366,1280.081,16.962,129).attr(attrblank);
			inter3.battlei15 = R.rect(492.816,1280.081,16.962,129).attr(attrblank);
			inter3.battlei16 = R.rect(514.266,1280.081,16.962,129).attr(attrblank);
			inter3.battlei17 = R.rect(535.716,1280.081,16.962,129).attr(attrblank);
			inter3.battlei18 = R.rect(557.166,1280.081,16.962,129).attr(attrblank);
			inter3.battlei19 = R.rect(578.616,1280.081,16.962,129).attr(attrblank);
			inter3.battlei20 = R.rect(600.066,1280.081,16.962,129).attr(attrblank);
			inter3.battlei21 = R.rect(621.516,1280.081,16.962,129).attr(attrblank);
			inter3.battlei22 = R.rect(642.966,1280.081,16.962,129).attr(attrblank);
			inter3.battlei23 = R.rect(664.416,1280.081,16.962,129).attr(attrblank);
			inter3.battlei24 = R.rect(685.866,1280.081,16.962,129).attr(attrblank);
			inter3.battlei25 = R.rect(707.316,1280.081,16.962,129).attr(attrblank);
			inter3.battlei26 = R.rect(750.216,1280.081,16.962,129).attr(attrblank);
			inter3.battlei27 = R.rect(771.666,1280.081,16.962,129).attr(attrblank);
			inter3.battlei28 = R.rect(793.116,1280.081,16.962,129).attr(attrblank);
			inter3.battlei29 = R.rect(814.566,1280.081,16.962,129).attr(attrblank);
			inter3.battlei30 = R.rect(836.016,1280.081,16.962,129).attr(attrblank);
			inter3.battlei31 = R.rect(857.466,1280.081,16.962,129).attr(attrblank);
			inter3.battlei32 = R.rect(878.916,1280.081,16.962,129).attr(attrblank);
			...
			inter3.attend8 = R.rect(192.516,771.275,16.87,167.153).attr(attr);
			...
			inter3.messierca = R.rect(407.016,341.508,58.711,21.816).attr(attr);
			inter3.loweca = R.rect(471.366,341.508,16.587,21.816).attr(attr);
            ...
            for (var state in inter) {
             ...
             $(document).mousemove(function(e){
                  if (over){
                    $(tip).css("left", e.pageX-700).css("top", e.pageY-150).css("width", "500px");
                    $(tip).html(tipText);
                  }
              });
            ...
            for (var state3 in inter3) {
             ...
             $(document).mousemove(function(e){
                  if (over3){
                    $(tip).css("left", e.pageX+50).css("top", e.pageY+10).css("width", "500px");
                    $(tip).html(tipText);
                  }
              });
//
            ...
            for (var state4 in inter4) {
             ...
             $(document).mousemove(function(e){
                  if (over4){
                    $(tip).css("left", e.pageX+10).css("top", e.pageY-150).css("width", "200px");
                    $(tip).html(tipText);
                  }
              });
