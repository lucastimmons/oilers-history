$(window).load(function(){
			...
			//
			inter3.divposi23 = R.rect(514.266,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi24 = R.rect(535.716,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi25 = R.rect(557.166,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi26 = R.rect(578.616,981.068,17.314,86.663).attr(attrblank);
			inter3.divposi27 = R.rect(600.066,981.068,17.314,86.663).attr(attrblank);
			...
			inter.playoffi39 = R.rect(878.916,1131.812,16.775,84.248).attr(attrblank);
						...
						//attendance
			inter3.attend1 = R.rect(42.3664,901.729,16.87,36.812).attr(attr);
			inter3.attend2 = R.rect(63.8164,896.147,16.87,42.394).attr(attr);
			inter3.attend3 = R.rect(106.716,862.677,16.87,75.864).attr(attr);
			inter3.attend4 = R.rect(85.2664,835.838,16.87,102.559).attr(attr);
			inter3.attend5 = R.rect(128.166,858.316,16.87,80.225).attr(attr);
			inter3.attend6 = R.rect(149.616,840.686,17.06,97.855).attr(attr);
			inter3.attend7 = R.rect(171.066,830.638,16.87,107.903).attr(attr);
			inter3.attend8 = R.rect(192.516,790.826,16.87,147.57).attr(attr);
			inter3.attend9 = R.rect(213.966,771.275,16.87,167.153).attr(attr);
			inter3.attend10 = R.rect(235.416,771.275,16.87,167.153).attr(attr);
			inter3.attend11 = R.rect(256.866,771.275,16.87,167.153).attr(attr);
			inter3.attend12 = R.rect(278.316,770.993,16.87,167.399).attr(attr);
			inter3.attend13 = R.rect(299.766,770.993,16.87,167.545).attr(attr);
			inter3.attend14 = R.rect(321.216,773.997,16.87,164.541).attr(attr);
			inter3.attend15 = R.rect(342.666,770.441,16.87,167.955).attr(attr);
			inter3.attend16 = R.rect(364.116,771.276,16.87,167.12).attr(attr);
			inter3.attend17 = R.rect(385.566,771.276,16.87,167.12).attr(attr);
			inter3.attend18 = R.rect(407.016,775.826,16.87,162.57).attr(attr);
			inter3.attend19 = R.rect(428.466,776.964,16.87,161.578).attr(attr);
			inter3.attend20 = R.rect(449.916,783.504,16.87,155.038).attr(attr);
			inter3.attend21 = R.rect(471.366,796.229,16.87,142.313).attr(attr);
			inter3.attend22 = R.rect(492.816,810.155,16.87,128.388).attr(attr);
			inter3.attend23 = R.rect(514.266,812.999,16.87,125.393).attr(attr);
			inter3.attend24 = R.rect(535.716,820.393,16.87,118).attr(attr);
			inter3.attend25 = R.rect(557.166,784.927,16.87,153.465).attr(attr);
			inter3.attend26 = R.rect(578.616,782.936,16.87,155.456).attr(attr);
			inter3.attend27 = R.rect(600.066,782.936,16.87,155.456).attr(attr);
			...
			inter3.pocklingtono = R.rect(149.616,106.354,446.015,21.816).attr(attr);
			...
			inter.tambellinig = R.rect(814.566,170.318,92.664,21.816).attr(attr);
			inter.mactg = R.rect(909.566,170.318,8.664,21.816).attr(attr);
			...
			inter3.mucklerc = R.rect(394.835,255.771,50.123,21.816).attr(attr);
			inter3.greenc = R.rect(449.916,255.771,49.737,21.816).attr(attr);
			...
			inter3.fogolinac = R.rect(235.416,341.508,37.363,21.816).attr(attr);
			inter3.gretzkyca = R.rect(278.566,341.508,103.061,21.816).attr(attr);
			inter3.messierca = R.rect(386.0,341.508,58.711,21.816).attr(attr);
			inter3.loweca = R.rect(451.0,341.508,16.587,21.816).attr(attr);
			...
			inter3.allstar19.transform("t11,0");
			inter3.allstar20.transform("t11,0");
			inter3.allstar21.transform("t11,0");
			inter3.allstar22.transform("t12,0");
			inter3.allstar23.transform("t12,0");
			inter3.allstar24.transform("t12,0");
			inter3.allstar25.transform("t12,0");
			inter3.allstar26.transform("t12,0");
			inter3.allstar27.transform("t12,0");
			...
			inter3.winper21 = R.rect(471.366,595.697,16.659,65.396).attr(attr);
			inter3.winper22 = R.rect(492.816,598.217,16.659,62.857).attr(attr);
			inter3.winper23 = R.rect(514.266,585.669,16.659,75.424).attr(attr);
			inter3.winper24 = R.rect(535.716,583.983,16.659,77.109).attr(attr);
			inter3.winper25 = R.rect(557.166,568.185,16.659,92.907).attr(attr);
			inter3.winper26 = R.rect(578.616,570.774,16.659,90.3).attr(attr);
			inter3.winper27 = R.rect(600.066,575.849,16.659,85.226).attr(attr);
			inter.winper28 = R.rect(621.516,578.798,16.659,82.276).attr(attr);
			inter.winper29 = R.rect(642.966,560.323,16.659,100.751).attr(attr);
			inter.winper30 = R.rect(664.416,563.179,16.659,97.896).attr(attr);
			inter.winper31 = R.rect(685.866,568.182,16.659,92.893).attr(attr);
			inter.winper32 = R.rect(707.316,568.182,16.659,92.893).attr(attr);
			inter.winper33 = R.rect(750.216,555.313,16.659,105.761).attr(attr);
			inter.winper34 = R.rect(771.666,578.792,16.659,82.282).attr(attr);
			inter.winper35 = R.rect(793.116,555.313,16.659,105.761).attr(attr);
			inter.winper36 = R.rect(814.566,563.179,16.659,97.896).attr(attr);
			inter.winper37 = R.rect(836.016,590.7,16.659,70.374).attr(attr);
			inter.winper38 = R.rect(857.466,596.539,16.659,64.535).attr(attr);
			inter.winper39 = R.rect(878.916,578.792,16.659,82.282).attr(attr);
			...
			backgg.text21a = R.text(905,200,"CM").attr(textmiddlewhite);
...
//
            ...
            for (var state4 in inter4) {
             ...
             $(document).mousemove(function(e){
                  if (over4){
                    $(tip).css("left", e.pageX-500).css("top", e.pageY-800).css("width", "200px");
                    $(tip).html(tipText);
                  }
              });
